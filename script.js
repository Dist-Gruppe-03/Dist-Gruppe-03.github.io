$(document).ready(function() {
	...
	$("#login_form").submit(function(event){
		...
		$.get("https://ubuntu4.saluton.dk:38055/RestServer/hangman/play/json/s114992?reset=true", function(result){
	...
	$("#guess_form").submit(function(event){
		event.preventDefault();
		$.get("https://ubuntu4.saluton.dk:38055/RestServer/hangman/play/json/s114992?letter=" + $("#letter").val(), function(result){
